  ...
  return (
    <div className="">
      <section class="bg-white dark:bg-gray-900">
        <div class="xl:px-32 lg:px-20 px-12 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
          <h2 class="font-[lexend] text-[32px] text-[#029967] my-4 font-bold">
            Frequently asked questions
          </h2>
          <div class="grid pt-8 text-left border-t border-gray-200 md:gap-16 dark:border-gray-700 md:grid-cols-2">
            <div>
              <div class="mb-10">
                <h3 class="flex items-center font-[lexend] text-[20px] mb-2">
                  <svg
                    class="flex-shrink-0 mr-2 w-5 h-5 font-[lexend] text-[#6A6A6A] text-[15px]"
                    fill="currentColor"
                    viewBox="0 0 20 20"
                ...
                <p class="font-[lexend] text-[#6A6A6A] text-[15px]">
